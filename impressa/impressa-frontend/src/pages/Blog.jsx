      ...
      <main>
        ...
        <section className="relative py-20 bg-white dark:bg-charcoal-800 border-b border-cream-200 dark:border-charcoal-700 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-7xl px-4 text-center">
            <h1 className="text-5xl md:text-6xl font-black text-charcoal-800 dark:text-white mb-6">Kuri Macye <span className="text-terracotta-500 dark:text-terracotta-400">Blog</span></h1>
