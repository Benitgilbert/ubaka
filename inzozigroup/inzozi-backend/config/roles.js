...
export const ALL_PERMISSIONS = [
  ...
  // 32 Grouped Impressa E-Commerce Admin Features
  { code: 'manage_impressa_users', name: 'Users', description: 'Manage e-commerce customer and cashier accounts', system: 'Impressa' },
  { code: 'manage_impressa_sellers', name: 'Sellers', description: 'Manage platform merchant seller profiles', system: 'Impressa' },
  { code: 'manage_impressa_violations', name: 'Violations', description: 'Auto-detect, issue, or resolve merchant policy violations', system: 'Impressa' },
  { code: 'view_impressa_seller_reports', name: 'Seller Reports', description: 'View seller sales performance, payouts, and activity logs', system: 'Impressa' },
  { code: 'manage_impressa_orders', name: 'Orders', description: 'View and update order processing and printing portals', system: 'Impressa' },
  { code: 'manage_impressa_inquiries', name: 'Inquiries / Quotes', description: 'Manage client custom quote requests and inquiries', system: 'Impressa' },
  { code: 'manage_impressa_products', name: 'Products', description: 'Manage e-commerce product catalog inventory', system: 'Impressa' },
  { code: 'approve_impressa_products', name: 'Product Approval', description: 'Review and approve vendor products in Impressa catalog', system: 'Impressa' },
  { code: 'manage_impressa_shifts', name: 'Shifts', description: 'Track employee POS shifts and drawer cash reconciliation', system: 'Impressa' },
  { code: 'manage_impressa_categories', name: 'Categories', description: 'Manage catalog store categories', system: 'Impressa' },
  { code: 'manage_impressa_attributes', name: 'Attributes', description: 'Manage product custom fields and attributes', system: 'Impressa' },
  { code: 'manage_impressa_reviews', name: 'Reviews', description: 'Monitor and moderate customer product reviews', system: 'Impressa' },
  { code: 'manage_impressa_tickets', name: 'Support Tickets', description: 'Respond to client help requests and tickets', system: 'Impressa' },
  { code: 'manage_impressa_customer_queries', name: 'AI Customer Queries', description: 'Oversee and audit automated chatbot conversations', system: 'Impressa' },
  { code: 'manage_impressa_abonnes', name: 'Client Abonnés', description: 'Manage subscribers and abonne accounts', system: 'Impressa' },
  { code: 'manage_impressa_coupons', name: 'Coupons', description: 'Manage marketing and discount coupons', system: 'Impressa' },
  { code: 'manage_impressa_gift_cards', name: 'Gift Cards', description: 'Issue and track digital gift cards', system: 'Impressa' },
  { code: 'manage_impressa_gift_card_products', name: 'Gift Card Products', description: 'Configure purchaseable gift card types', system: 'Impressa' },
  { code: 'manage_impressa_flash_sales', name: 'Flash Sales', description: 'Configure active promotional campaigns and discounts', system: 'Impressa' },
  { code: 'manage_impressa_banners', name: 'Banners', description: 'Manage landing page promotional banners', system: 'Impressa' },
  { code: 'manage_impressa_testimonials', name: 'Testimonials', description: 'Moderate client platform testimonials', system: 'Impressa' },
  { code: 'manage_impressa_blogs', name: 'Blogs', description: 'Publish and edit articles on the Impressa Blog', system: 'Impressa' },
  { code: 'manage_impressa_brand_partners', name: 'Brand Partners', description: 'Manage vendor brand partnerships and logos', system: 'Impressa' },
  { code: 'manage_impressa_finance', name: 'Finance', description: 'View financial balance sheets and transactions', system: 'Impressa' },
  { code: 'manage_impressa_commissions', name: 'Commissions', description: 'Configure platform fee rates', system: 'Impressa' },
  { code: 'manage_impressa_payouts', name: 'Payouts', description: 'Process merchant payouts and withdrawals', system: 'Impressa' },
  { code: 'manage_impressa_site_settings', name: 'Site Settings', description: 'Edit general e-commerce configuration', system: 'Impressa' },
  { code: 'manage_impressa_subscribers', name: 'Subscribers', description: 'Manage email newsletter subscribers', system: 'Impressa' },
...
export const ALL_ROLES = [
  {
    ...
    permissions: [
      ...
      'manage_hr',
      'submit_requests',
      // Impressa Permissions (32 features)
